...
/**
 * `BC_Gradient` is styled for the purpose of using it as an alternative multifunctional button.
 *
 * @param children - Recommended `text`
 */
export const BC_Gradient = ({ children, className, ...rest }: ButtonProps) =>
<>
